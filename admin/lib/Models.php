...
/* =========================================================
   ...
   Peticiones que llegan y no caen en ningun proyecto. El administrador las
   recibe, decide a quien derivarlas (mirando la carga de cada persona) y el
   resto del equipo las ve en su bandeja, esten o no asignadas a ellos.
   ========================================================= */
class RequerimientoRepo
{
    ...
    /** Requerimientos sin derivar todavia: es el numero que urge al admin. */
    ...
    /** Abiertos que tiene encima una persona (para su bandeja y su carga). */
    ...
    /**
     * Deriva a una o varias personas. Con la lista vacia vuelve a la bandeja.
     * Escribe tambien 'asignado_a' en 0 para que no quede el dato viejo
     * contradiciendo a la lista nueva.
     */
    public function asignar(int $id, array $miembroIds): bool
    {
